...
class TransactionRepositoryImpl implements TransactionRepository {
  ...
  Future<Either<Failure, Map<String, dynamic>>> getPaginatedTransactions({
    ...
    try {
      ...
      if (cachedTransactions.isNotEmpty) {
        ...
        final paginatedTransactions = cachedTransactions
            .skip(startIndex)
            .take(limit)
            .toList();
  ...
  Future<Either<Failure, Transaction>> createTransaction(Transaction transaction) async {
    try {
      final createdTransaction = await remoteDataSource.createTransaction(transaction);
  ...
  Future<Either<Failure, Transaction>> updateTransaction(Transaction transaction) async {
    try {
      final updatedTransaction = await remoteDataSource.updateTransaction(transaction);
